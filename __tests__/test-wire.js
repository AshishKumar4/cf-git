...
describe('git wire protocol', () => {
  it('writeRefsAd', async () => {
    ...
    expect(buffer.toString('utf8')).toBe(
      `01009ea43b479f5fedc679e3eb37803275d727bf51b7 HEAD\0multi_ack thin-pack side-band side-band-64k ofs-delta shallow deepen-since deepen-not deepen-relative no-progress include-tag multi_ack_detailed no-done symref=HEAD:refs/heads/master agent=git/cf-git@1.0.4
