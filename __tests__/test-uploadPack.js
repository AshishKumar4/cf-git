...
describe('uploadPack', () => {
  it('advertiseRefs: true', async () => {
    ...
    expect(buffer.toString('utf8')).toBe(
      `00dd5a8905a02e181fe1821068b8c0f48cb6633d5b81 HEAD\0thin-pack side-band side-band-64k shallow deepen-since deepen-not allow-tip-sha1-in-want allow-reachable-sha1-in-want symref=HEAD:refs/heads/master agent=git/cf-git@1.0.5
